...
> **最后更新：** 2026-06-10（新增 WIP 催开票必填校验与归零清空规则）
...
- **实现：** `js/stock-validation.js`、`js/wip-validation.js`；字段字典列 R/S/AL/AM/AN/AO 中文名与说明（`Store.fieldDictionary`）；`ProjectEditor.js` 筛选 / 样式 / 提交校验。

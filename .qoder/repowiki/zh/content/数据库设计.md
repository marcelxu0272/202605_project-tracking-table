...
**章节来源**
- [database-schema.sql:1-411](file://database-schema.sql#L1-L411)
- [server/db.js:1-667](file://server/db.js#L1-L667)
- [server/index.js:1-775](file://server/index.js#L1-L775)
...
- 字段定义与约束：
  - 主键：id
  - 字段：sector_code、period、status、approval_node、baseline_version、created_at、updated_at
...
- 字段定义与约束：
  - 主键：id
  - 外键：report_line_id → report_lines.id
  - 字段：report_line_id、action、actor_role、actor_name、comment、from_status、to_status、created_at
